...
declare class ChestForm {
	 ...
	 */
	button(slot: number, itemName?: string, itemDesc?: string[], texture?: string, stackAmount?: number, enchanted?: boolean, callback?: (number: number) => void): ChestForm;
	/**
	...
	*/
	pattern(from: [number, number], pattern: string[], key: { [key: string]: { itemName?: string, itemDesc?: string[], stackSize?: number, enchanted?: boolean, iconPath: string, callback: (slot: number) => void } }): ChestForm;
	/**
	  * @remarks
